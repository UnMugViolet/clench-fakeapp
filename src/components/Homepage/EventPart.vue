...
<template>
  ...
  <div class="flex flex-col md:flex-row w-full gap-10 md:gap-20">
    ...
    <div class="w-full md:w-1/2 flex items-center">
      <div class="ml-3">
        <p class="md:mr-40 text-md md:text-lg">Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie depuis les années 1500, quand un imprimeur anonyme assembla ensemble des morceaux de texte pour réaliser un livre spécimen de polices de texte.</p>
